        ...
        emitter-ts exists to solve a narrow, inspectable developer-tooling problem:
        Strict typed event emitter with sync/async dispatch, once/off, and listener-error isolation.
        ...
        Topics: async, event-emitter, events, type-safe, typescript, zero-dependencies
